            ...
            <div style={styles.content}>
                ...
                <aside style={styles.profileCard}>
                    ...
                    <div style={styles.links}>
                        <a href={profile.github || '#'} style={styles.link}>🌐 GitHub</a>
                        <a href={profile.linkedin || '#'} style={styles.link}>💼 LinkedIn</a>
                        <a href={profile.website || '#'} style={styles.link}>🌍 Personal Site</a>
                    </div>
...
const styles = {
    ...
    avatar: { width: '120px', height: '120px', borderRadius: '50%', background: 'linear-gradient(135deg, #0FF6FC, #A259FF)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '48px', fontWeight: 700, margin: '0 auto', border: '4px solid rgba(162, 89, 255, 0.3)' },
    ...
    links: { display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' },
    link: { color: '#0FF6FC', textDecoration: 'none', fontSize: '14px' },
    editBtn: { width: '100%', background: 'linear-gradient(135deg, #FF6B9D, #C084FC)', border: 'none', padding: '12px', borderRadius: '8px', color: 'white', fontWeight: 600, cursor: 'pointer', marginBottom: '20px', fontFamily: 'Orbitron, sans-serif' },
    stats: { borderTop: '1px solid rgba(162, 89, 255, 0.3)', paddingTop: '16px' },
    statsTitle: { fontSize: '14px', marginBottom: '12px', fontFamily: 'Orbitron, sans-serif' },
    statItem: { margin: '8px 0', fontSize: '14px' },
    ...
    sectionTitle: { fontSize: '22px', margin: 0, marginBottom: '16px', fontFamily: 'Orbitron, sans-serif' },
    projectGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '16px', marginBottom: '16px' },
    loadMore: { width: '100%', background: 'transparent', border: '2px solid rgba(162, 89, 255, 0.5)', padding: '12px', borderRadius: '8px', color: '#A259FF', cursor: 'pointer', fontWeight: 600 },
    addBtn: { background: 'transparent', border: '2px solid rgba(255, 154, 60, 0.5)', padding: '8px 16px', borderRadius: '8px', color: '#FF9A3C', cursor: 'pointer', fontWeight: 600, fontSize: '12px' },
    logsContainer: { display: 'flex', flexDirection: 'column', gap: '12px' },
    logEntry: { background: 'rgba(162, 89, 255, 0.1)', padding: '12px', borderRadius: '8px', borderLeft: '3px solid #A259FF' },
    ...
    widgetTitle: { fontSize: '16px', marginBottom: '16px', fontFamily: 'Orbitron, sans-serif' },
    highlights: { display: 'flex', flexDirection: 'column', gap: '12px' },
    highlight: { fontSize: '14px', opacity: 0.8 }
};
